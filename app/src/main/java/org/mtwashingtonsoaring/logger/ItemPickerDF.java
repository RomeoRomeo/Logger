...
/**
 * Created by Rick on 7/11/2016.
 */

//https://gist.github.com/kristopherjohnson/660656bb9e18e23146c0
 ...
 */
public class ItemPickerDF extends DialogFragment {
    public static final String LOGTAG = "ItemPickerDF";
    ...
    public interface OnItemSelectedListener {
        void onItemSelected(ItemPickerDF fragment, Item item, int index);
    }
     ...
     */
    public static ItemPickerDF newInstance(String title, ArrayList<Item> items, int selectedIndex) {
        Bundle args = new Bundle();
        args.putString(ARG_TITLE, title);
        args.putBundle(ARG_ITEMS, Item.bundleOfItems(items));
        args.putInt(ARG_SELECTED_INDEX, selectedIndex);

        ItemPickerDF fragment = new ItemPickerDF();
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (activity instanceof OnItemSelectedListener) {
                            if (0 <= selectedIndex && selectedIndex < items.size()) {
                                ...
                                listener.onItemSelected(ItemPickerDF.this, item, selectedIndex);
                            }
                        }
                    }
                })
